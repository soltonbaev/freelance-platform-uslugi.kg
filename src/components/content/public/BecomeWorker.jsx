      ...
      <Container>
        <Box textAlign="center" width="60vw" sx={{ margin: "50px auto" }}>
          <Typography sx={{ fontSize: { xs: "22px", sm: "26px" } }}>
            "Благодаря сайту uslugi.kg я смог найти работу и расплатиться с
            долгами, расплатиться по счетам, обеспечить свою семью, и у меня все
            еще оставалось достаточно места для будущих целей."
          </Typography>
