...
const BecomeWorker = () => {
   useEffect(() => {
      ConsoleGroup('Spawning BecomeWorker...');
      return () => {
         ConsoleGroupEnd('Ending BecomeWorker...');
      };
   }, []);
         ...
         <Container>
            ...
            >
               ...
               <Typography variant="h6">
                  ...
                  графику. С TaskRabbit у вас есть свобода и поддержка, чтобы
            ...
            <Grid container spacing={{xs: 2, md: 6}} columns={{sm: 2, md: 12}}>
               <Grid item xs={1} sm={2} md={4} sx={{marginBottom: '30px'}}>
                  ...
                  <Typography variant="h6">
                     Работайте как, когда и где хотите. Предлагайте услуги в
                     категориях и устанавливайте гибкий график и зону работы.
                  </Typography>
               </Grid>
               <Grid item xs={1} sm={2} md={4} sx={{marginBottom: '30px'}}>
                  ...
                  <Typography variant="h6">
                     ...
                     саморекламы, чтобы вы могли сосредоточиться на том, что у
               ...
               <Grid item xs={1} sm={2} md={4} sx={{marginBottom: '30px'}}>
                  ...
                  <Typography variant="h6">
                     Вы сохраняете 100% того, что вы берете, плюс чаевые!
                     Выставляйте счета и получайте оплату напрямую через нашу
                     безопасную платежную систему.
                  </Typography>
               </Grid>
            </Grid>
            {/* ======== */}
            ...
            <Container>
               ...
               >
                  ...
                  >
                     ...
                     <Typography color="black" variant="h6">
                        uslugi.kg связывает занятых людей, нуждающихся в помощи,
                        с надежными местными таскировщиками, которые могут
                        помочь во всем, от ремонта дома до поручений. Как
                        Tasker, вы можете получать деньги за то, что вам
                        нравится, когда и где вы хотите, и при этом спасать день
                        для кого-то в вашем городе.
                     </Typography>
                  </Box>
               </Box>
            </Container>
            ...
            <Box>
               ...
               >
                  ...
                  <Grid item xs={1} sm={2} md={4} sx={{marginBottom: '30px'}}>
                     ...
                     <Typography variant="h6">
                        В соответствующих городах мы взимаем регистрационный
                        сбор в размере 1000 сом, что помогает нам предоставлять
                        вам наилучшие услуги.
                     </Typography>
                  </Grid>
                  <Grid item xs={1} sm={2} md={4} sx={{marginBottom: '30px'}}>
                     <Typography
                     ...
                     <Typography variant="h6">
                        Установите еженедельную доступность и согласитесь
                        получать задания в тот же день.
                     </Typography>
                  </Grid>
                  <Grid item xs={1} sm={2} md={4} sx={{marginBottom: '30px'}}>
                     <Typography
         ...
         <Container>
            <Box textAlign="center" width="60vw" sx={{margin: '50px auto'}}>
               <Typography sx={{fontSize: {xs: '22px', sm: '26px'}}}>
                  "Благодаря сайту uslugi.kg я смог найти работу и расплатиться
                  с долгами, расплатиться по счетам, обеспечить свою семью, и у
                  меня все еще оставалось достаточно места для будущих целей."
               </Typography>
               <Typography mt="10px" sx={{fontSize: {xs: '18px', sm: '22px'}}}>
                  Иван И.И., Бишкек
               </Typography>
            </Box>
         </Container>
