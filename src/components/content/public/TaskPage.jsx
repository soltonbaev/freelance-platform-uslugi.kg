...
const TaskPage = () => {
  const { categoriesArr, servicesArr, getServices, getCategoriesServices } =
    useGlobalContext();
    ...
    <Box>
      ...
      >
        ...
        >
          ...
          <Divider
            width="50px"
            sx={{ mt: "10px", mb: "20px", background: "black" }}
          />
      ...
      <Container sx={{ mt: "50px", mb: "50px" }}>
        ...
        <Grid container spacing={{ xs: 2, md: 6 }} columns={{ sm: 2, md: 9 }}>
          <Grid item xs={1} md={3}>
            <Box
              width="300px"
              height="300px"
            ...
            <Typography variant="h5">1. Опишите свою задачу</Typography>
            <Typography variant="h6">
              Расскажите нам, что вам нужно сделать, когда и где это работает
              для вас.
            </Typography>
          </Grid>
          <Grid item xs={1} md={3}>
            <img src={choose} width="300px" />
            <Typography variant="h5">2. Выберите работника</Typography>
            <Typography variant="h6">
              Просмотрите доверенных работников по навыкам, отзывам и цене.
              Поговорите с ними, чтобы подтвердить детали.
            </Typography>
          </Grid>
          <Grid item xs={1} md={3}>
            ...
            <Typography variant="h6">
              Ваш работник прибывает и выполняет свою работу. Оплачивайте
              безопасно и оставляйте отзывы прямо здесь.
            </Typography>
          </Grid>
        </Grid>
      </Container>
